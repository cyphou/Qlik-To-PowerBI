...
class TestPhase5Documentation:
    ...
    def test_copilot_instructions_updated(self, project_root_dir):
        ...
        assert f.exists()
        content = f.read_text("utf-8")
        assert "2,900" in content or "2900" in content or "2,605" in content or "2605" in content, "copilot-instructions should have updated test count"
        assert "12.0.0" in content or "11.0.0" in content
...
class TestPhase6Housekeeping:
    ...
    def test_version_9_in_powerbi_import(self):
        ...
        assert powerbi_import.__version__ == '12.0.0'
